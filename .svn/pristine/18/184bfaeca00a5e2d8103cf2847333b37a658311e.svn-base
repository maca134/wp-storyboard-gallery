 ...
 */
function wpsbg_optionsframework_fields() {
    ...
    foreach ($options as $value) {
        ...
        switch ($value['type']) {
            ...
            // Uploader
            case "upload":
                $output .= wpsbg_optionsframework_medialibrary_uploader($value['id'], $val, null); // New AJAX Uploader using Media Library	
                break;
            ...
            case 'typography':
                ...
                $faces = wpsbg_of_recognized_font_faces();
                ...
                /* Font Style */
                $styles = wpsbg_of_recognized_font_styles();
            ...
            case 'background':
                ...
                $output .= wpsbg_optionsframework_medialibrary_uploader($value['id'], $background['image'], null, '', 0, 'image');
                ...
                $repeats = wpsbg_of_recognized_background_repeat();
                ...
                $positions = wpsbg_of_recognized_background_position();
                ...
                $attachments = wpsbg_of_recognized_background_attachment();
            ...
            case "info":
                ...
                if ($value['desc']) {
                    $output .= apply_filters('wpsbg_of_sanitize_info', $value['desc']) . "\n";
                }
