...
A simple plugin that adds a storyboard style gallery to posts and pages. 
...
* Set images to goto another page.
...
2. Search for "WP Storyboard Galleries".
3. Click install.
4. Click activate.
...
1. This is an example of editting a post.
2. This is an example of what is displayed on a post.
